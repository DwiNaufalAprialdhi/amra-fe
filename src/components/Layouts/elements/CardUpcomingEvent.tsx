...
export default function CardUpcomingEvent(props: CardUpcomingEventProps) {
      return (
            <>
                  <Link href={props.link} className='w-full flex flex-col lg:rounded-[10px] rounded-[8px] overflow-hidden group'>
                        ...
                        <div className='flex flex-col gap-y-1 mt-[14px]'>
                              <h2 className='font-medium lg:text-base text-sm text-slate-800 line-clamp-1'>
                                    {props.title}
                              </h2>
                              <h4 className='font-normal lg:text-sm text-xs text-slate-600 line-clamp-1'>
                                    {props.category}
                              </h4>
                        </div>
                  </Link>
